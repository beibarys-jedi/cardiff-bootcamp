# Lesson 4 - Intro & Primitives

## Intro

![cake](https://bunny-wp-pullzone-lcnorhfy96.b-cdn.net/wp-content/uploads/html_css_javascript_suit_outline-1.jpg)
...
An example you should open:

1. Правый щелчок мышкой -> Open so 'Просмотреть код страницы'
2. Открыть вкладку 'Консоль'
3. И начать печатать и играться

Ниже пример
![working with console](./datatypes.png)

## Homework

Create simple calculator app from terminal input.

- It should accept 4 operations: `+`, `-`, `/`, `*`.

- On any error use your own judgement.

- Technologies needs to be used: terminal(powershell in Windows), NodeJS, git, Javascript.

- Create repo in github and send me link.
